...
<h2>OVERVIEW</h2>
    <p>Superconducting transmon qubits — the workhorses of modern quantum processors — suffer from low anharmonicity and frequency crowding <p>(\(|\alpha / 2\pi| \in [150, 300] \, \text{MHz}\))</p>, which often leads to spectral overlap of control pulses with higher transitions such as <p>\(|1\rangle \leftrightarrow |2\rangle\).</p> This overlap causes leakage errors, which are a major limitation in achieving high-fidelity quantum gates.</p>
