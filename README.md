...
<h2>OVERVIEW</h2>
<p>Superconducting transmon qubits — the workhorses of modern quantum processors — suffer from low anharmonicity and frequency crowding \(\left| \frac{\alpha}{2\pi} \right| \in [150, 300] \, \text{MHz}\), which often leads to spectral overlap of control pulses with higher transitions such as \( |1\rangle \leftrightarrow |2\rangle \). This overlap causes leakage errors, which are a major limitation in achieving high-fidelity quantum gates.</p>
